...
A recent [article](https://theconversation.com/lockdown-crime-trends-why-antisocial-behaviour-is-up-140479) of mine explored how crime trends changed in March and April following the lockdown using London as a case study. It used a descriptive visualisation inspired by those used in [the FT](https://www.ft.com/content/a26fbf7e-48f8-11ea-aeb3-955839e06441) to track coronavirus deaths whilst accounting for seasonal changes in death rates. A key characteristic of long-term crime trends is seasonality. To disentangle fluctuations in crime, and pinpoint irregularity resulting from lockdown measures, we must account for typical monthly fluctuations. Even then, monthly open data is [far from ideal](https://the-sra.org.uk/SRA/Blog/whyyoucantidentifychangesincrimebycomparingthismonthtolastmonth.aspx), but you can't have everything (especially when working from your living room).

We now have some updated data -- up to and including May -- which demonstrates the start of a turnaround upon the relaxation of lockdown rules. The code to make this visual is now available on [GitHub](https://github.com/langtonhugh/crime_covid_visual).

![](/img/full_met.png)

The dramatic declines in burglary, robbery, theft and shoplifting observed in March and April have began to reverse, or at least stabilise. Shops are beginning to re-open, and people returning to work are now leaving their homes unguarded. Bicycle theft has more or less returned to normal when compared with previous years. As lockdown restrictions have eased, opporunties for crime have begun to (re)emerge. Counts are still unusually low amongst many crime types, but we are certainly witnessing a turnaround.
...
Ashby, M. (2020). Changes in police calls for service during the early months of the 2020 coronavirus pandemic.

Gerell, M. (2020). Minor covid-19 association with crime in Sweden, a five week follow up.
