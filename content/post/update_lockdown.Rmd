...
We now have some updated data -- up to and including May -- which demonstrates the start of a turnaround in crime trends upon the relaxation of lockdown rules. The code to make this visual is now available on [GitHub](https://github.com/langtonhugh/crime_covid_visual).
